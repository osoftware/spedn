...
globals = Map.fromList
    ...
    , (Fun "reverseBytes",   [Array Byte $ SizeParam "s"] :-> Array Byte (SizeParam "s")
      ...
      -- Introspection
    , (Fun "inputIndex",          [] :-> Num)
    , (Fun "activeBytecode",      [] :-> Alias "ScriptCode")
    , (Fun "txVersion",           [] :-> Num)
    , (Fun "txInputCount",        [] :-> Num)
    , (Fun "txOutputCount",       [] :-> Num)
    , (Fun "txLockTime",          [] :-> Num)
    , (Fun "utxoValue",           [Num] :-> Num)
    , (Fun "utxoBytecode",        [Num] :-> Alias "ScriptCode")
    , (Fun "outpointTxHash",      [Num] :-> Alias "Sha256")
    , (Fun "outpointIndex",       [Num] :-> Num)
    , (Fun "inputBytecode",       [Num] :-> Alias "ScriptCode")
    , (Fun "inputSequenceNumber", [Num] :-> Num)
    , (Fun "outputValue",         [Num] :-> Num)
    , (Fun "outputBytecode",      [Num] :-> Alias "ScriptCode")

      -- Token inspection
    , (Fun "utxoTokenCategory",     [Num] :-> Alias "TokenCategory")
    , (Fun "utxoTokenCommitment",   [Num] :-> List Byte)
    , (Fun "utxoTokenAmount",       [Num] :-> Num)
    , (Fun "outputTokenCategory",   [Num] :-> Alias "TokenCategory")
    , (Fun "outputTokenCommitment", [Num] :-> List Byte)
    , (Fun "outputTokenAmount",     [Num] :-> Num)
...
bch :: Vm
bch = Vm (-9223372036854775807, 9223372036854775807) [globals]